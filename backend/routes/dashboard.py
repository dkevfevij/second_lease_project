...
# /camions : récupère camions avec tri, filtres et pagination
...
def get_camions():
    try:
        ...
        statut_filter = request.args.get('statut')          # en_attente, en_cours...
        alert_filter = request.args.get('alertes')          # true / false
